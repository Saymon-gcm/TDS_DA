...
<head>
    ...
    <link
        href="../../public/css/style-sequencia.css"
        rel="stylesheet"
        type="text/css">
...
<body>
    ...
    <div class="cabecalho">
        ...
        <div class="cabecalho-down">
            ...
            <main class="jogo-sequencia">
                ...
                <p class="instrucao">
                    Descubra qual elemento vem a seguir.
                </p>
    ...
    <script src="../../public/js/sequencia.js"></script>
