...
<head>
    ...
    <link
        href="../../public/css/style-logica.css"
        rel="stylesheet"
        type="text/css"
    >
...
<body>
    ...
    <div class="cabecalho">
        ...
        <div class="cabecalho-down">
            ...
            <main class="jogo-logica">
                ...
                <p class="instrucao">
                    Observe as opções e descubra a resposta correta.
                </p>
                ...
                <div class="pergunta-logica">

                    <p id="perguntaTexto">
                        Qual objeto não pertence ao grupo?
                    </p>
    ...
    <!-- JAVASCRIPT DA LÓGICA -->

    <script src="../../public/js/logica.js"></script>
